#!/usr/bin/env bash
# Fine LR sweep around e11_wide_lr012 (bin 0.923729, mc 0.567797).
set -uo pipefail
cd "$(dirname "$0")/.."
...
run_exp "e17_wide_lr0110" "${COMMON[@]}" --lr 0.011 --model-out experiments/model_e17.pt
run_exp "e18_wide_lr0115" "${COMMON[@]}" --lr 0.0115 --model-out experiments/model_e18.pt
run_exp "e19_wide_lr0125" "${COMMON[@]}" --lr 0.0125 --model-out experiments/model_e19.pt
run_exp "e20_wide_lr0130" "${COMMON[@]}" --lr 0.013 --model-out experiments/model_e20.pt
